...
|---|---|---|
| Schema Drizzle | Verificado | `drizzle/schema.ts`, journal y SQL están versionados; `scripts/verify-clean-schema.mjs` aplica el journal oficial completo sobre una base limpia y verifica 37 tablas y default `language=es`; se retiró el SQL 0000 duplicado no referenciado. |
