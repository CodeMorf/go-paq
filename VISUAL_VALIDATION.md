...
## Captura protegida — 24 de agosto de 2026

Se capturaron `/admin`, `/sucursal`, `/driver` y `/cliente` en viewport desktop 1280 × 720 y móvil 390 × 844. Los cuatro portales redirigen correctamente al acceso seguro cuando no existe sesión OAuth en el navegador; el login mantiene identidad GoPaq, CTA visible y composición vertical usable en móvil. Estas capturas verifican el shell responsive y la frontera de acceso, pero **no sustituyen la validación autenticada** de cabeceras internas, permisos, cámara, GPS ni flujos operativos.
