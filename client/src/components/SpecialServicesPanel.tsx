...
const statusLabels = { requested: "Solicitado", quoted: "Cotizado", awaiting_approval: "Pendiente de aprobación", approved: "Aprobado", purchasing: "Comprando", purchased: "Comprado", fulfillment: "En preparación", scheduled: "Programado", in_progress: "En curso", completed: "Completado", cancelled: "Cancelado", rejected: "Rechazado" } as const;
