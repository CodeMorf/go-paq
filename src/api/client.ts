...
export class ApiClient {
  ...
  static async updateBranchLocation(branchId: string, payload: { latitude: number | null; longitude: number | null }): Promise<ApiResponse<{ branch: any }>> { return this.request<{ branch: any }>(`/branches/${encodeURIComponent(branchId)}/location`, { method: 'PATCH', body: JSON.stringify(payload) }); }
